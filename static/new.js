...
var chinamap1 = echarts.init(document.getElementById('chinaMap1'), 'white', {renderer: 'canvas'});
...
document.getElementById('slider1').onchange =  function changeDate1(){
...
function fetchchinaMapData(chart) {
    ...
    $.ajax({
        ...
        url: "/chinamap",
        dataType: "json",
        data:  "index="+document.getElementById('slider').value,
...
function fetchchinaMapData1(chart) {   //xxx
    $.ajax({
        type: "GET",
        url: "/chinamap1",
        dataType: "json",
        data:  "index="+document.getElementById('slider1').value,
        success: function (result) {
            chart.setOption(result);
        }
    });
